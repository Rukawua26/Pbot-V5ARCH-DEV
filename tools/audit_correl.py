...
Uso:
    ...
    python tools/audit_correl.py --threshold 0.55
"""
...
def main():
    ...
    parser.add_argument(
        "--threshold", type=float, default=0.60, help="Umbral máximo de correlación"
    )
    parser.add_argument(
    ...
    print(f"  Umbral   : correlación < {args.threshold}")
    print(f"{'=' * 55}\n")
