...
class ExecutionLockSeparationTest(unittest.TestCase):
    ...
    def test_call_exchange_uses_exchange_lock(self):
        ...
        self.assertTrue(lock_held["inside_fn"], "exchange lock should be owned inside _call_exchange callback")
    ...
    def test_call_exchange_account_uses_account_lock(self):
        ...
        self.assertTrue(lock_held["inside_fn"], "account lock should be owned inside _call_exchange_account callback")
    ...
    def test_call_exchange_account_does_not_hold_exchange_lock(self):
        ...
        self.assertFalse(exchange_held["during"],
    ...
    def test_confirm_ioc_order_state_uses_account_lock(self):
        self.service.exchange.fetch_order = MagicMock(return_value={"status": "filled", "filled": 1.0})
    ...
    def test_fetch_open_interest_uses_account_lock(self):
        self.service.exchange.fetch_open_interest = MagicMock(return_value={"openInterest": "100.5"})
    ...
    def test_close_position_chase_fetch_ticker_uses_account_lock(self):
        ...
        with patch.object(self.service, "_call_exchange_account") as mock_acc:
            ...
            with patch("core.execution_service._execute_chase_limit_steps",
